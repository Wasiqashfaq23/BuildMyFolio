  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6" aria-label="Portfolio statistics">
          {[
            { label: "Published", value: publishedCount },
            { label: "Total Views", value: totalViews },
          ].map(({ label, value }) => (
            <div key={label} className="bg-white dark:bg-slate-900 rounded-lg p-4 border border-slate-200 dark:border-slate-700/60">
