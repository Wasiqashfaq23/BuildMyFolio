      ...
      {showPreview && (
        <div className="fixed inset-0 z-50 bg-slate-50 overflow-y-auto">
          <div className="sticky top-0 z-10 bg-white border-b border-slate-200 px-4 sm:px-6 py-4 flex items-center justify-between">
            <h2 className="text-lg font-bold text-slate-900">Review Your Portfolio</h2>
            <button
      ...
      {showSubmitConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="submit-title">
          ...
          <div className="relative bg-white rounded-xl shadow-lg border border-slate-200 p-6 w-full max-w-sm">
            <h2 id="submit-title" className="text-lg font-bold text-slate-900 mb-2">Create portfolio?</h2>
            <p className="text-sm text-slate-500 mb-6">Your portfolio will be published and visible to anyone with the link.</p>
