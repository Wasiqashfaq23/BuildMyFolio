...
function PublicPortfolio() {
  ...
  return (
    <div>
      {user && (
        <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-md flex items-center gap-3 bg-[#111] border border-[#222] rounded-xl px-4 py-2.5 shadow-xl">
          <button
          ...
          <span className="text-xs text-[#555] truncate min-w-0">{publicUrl}</span>
          <button
            onClick={handleCopy}
            className="flex items-center gap-1.5 bg-[#f5f5f5] text-[#080808] px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-white transition shrink-0 ml-auto"
          >
